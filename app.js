// Control Bionics Support V1.4 — static / no API
const CONFIG = {
  supportEmail: "Support.au@controlbionics.com",
  links: {
    controlBionics: "https://controlbionics.com/",
    instagram: "https://www.instagram.com/controlbionicsaus/",
    booking: "https://bookings.cloud.microsoft/book/ControlBionics@controlbionics.com/?ismsaljsauthenabled=true",
    irisbond: "https://www.irisbond.com/en/",
    intelligaze: "https://www.intelligaze.com/en/home",
    grid3: "https://hub.thinksmartbox.com/topic/grid-3/",
    grid3HowTo: "https://hub.thinksmartbox.com/topic/how-to-use-grid-3/",
    gridIPad: "https://hub.thinksmartbox.com/topic/grid-for-ipad/",
    smartboxInfo: "https://hub.thinksmartbox.com/topic/product-information/",
    rehadapt: "https://rehadapt.com/"
  }
};
...
const SECTIONS = {
  ...
  grid3: {
    ...
    issues:[
      ...
      { title:"Official Grid 3 resources", desc:"Open Smartbox Grid 3 Windows help, how-to guides, Grid for iPad and product information.", article:"grid-resources", tag:"EXTERNAL LINKS" }
    ]
  },
  neurostrip: {
  ...
  general: {
    ...
    issues:[
      ...
      { title:"Book a Support / Product session", desc:"Open the Control Bionics Microsoft Bookings page.", article:"booking", tag:"BOOK ONLINE" },
      { title:"Eye-gaze camera resources", desc:"Official IRISBOND Hiru and Alea IntelliGaze information.", article:"eyegaze-resources", tag:"RESOURCES" },
      { title:"Mounting resources", desc:"Rehadapt information for table stands, floorstands and wheelchair mounts.", article:"mount-resources", tag:"MOUNTS" },
      { title:"Useful external links", desc:"Control Bionics website, Instagram, Smartbox, eye-gaze and mounting resources.", article:"external-resources", tag:"LINKS" }
    ]
  }
};

const ARTICLES = {
  "booking": { area:"General Enquiries", title:"Book with Control Bionics", summary:"Book time with a Control Bionics Product Specialist or Customer Support.", body:`<h3>Online booking</h3><p>Use the official Control Bionics booking page to arrange a session with a Product Specialist or Customer Support.</p><p><a class="article-link" href="${CONFIG.links.booking}" target="_blank" rel="noopener">Open Control Bionics booking page ↗</a></p>` },
  "eyegaze-resources": { area:"NeuroNode & AAC", title:"Eye-gaze camera resources", summary:"Official external resources for IRISBOND Hiru and Alea IntelliGaze eye-gaze cameras.", body:`<h3>IRISBOND Hiru</h3><p>Use IRISBOND's official site for further Hiru product and eye-tracking information.</p><p><a class="article-link" href="${CONFIG.links.irisbond}" target="_blank" rel="noopener">Open IRISBOND Hiru resources ↗</a></p><h3>Alea IntelliGaze</h3><p>Use the official IntelliGaze site for information relating to Alea eye-tracking hardware and IntelliGaze.</p><p><a class="article-link" href="${CONFIG.links.intelligaze}" target="_blank" rel="noopener">Open Alea IntelliGaze resources ↗</a></p>` },
  "grid-resources": { area:"Grid 3", title:"Official Smartbox Grid resources", summary:"Official Smartbox support information for Grid 3 on Windows and Grid for iPad.", body:`<h3>Grid 3 — Windows</h3><p><a class="article-link" href="${CONFIG.links.grid3}" target="_blank" rel="noopener">Open Grid 3 support hub ↗</a></p><p><a class="article-link" href="${CONFIG.links.grid3HowTo}" target="_blank" rel="noopener">How to use Grid 3 ↗</a></p><h3>Grid for iPad</h3><p><a class="article-link" href="${CONFIG.links.gridIPad}" target="_blank" rel="noopener">Open Grid for iPad support ↗</a></p><h3>Smartbox product information</h3><p><a class="article-link" href="${CONFIG.links.smartboxInfo}" target="_blank" rel="noopener">Open Smartbox product information ↗</a></p>` },
  "mount-resources": { area:"General Enquiries", title:"Mounting resources", summary:"External information for table stands, floorstands and wheelchair mounts.", body:`<h3>Rehadapt mounting systems</h3><p>For mounting information such as table stands, floorstands and wheelchair mounts, open Rehadapt's official site.</p><p><a class="article-link" href="${CONFIG.links.rehadapt}" target="_blank" rel="noopener">Open Rehadapt ↗</a></p>` },
  "external-resources": { area:"General Enquiries", title:"Useful external links", summary:"Official Control Bionics, eye-gaze, Grid/Smartbox and mounting resources.", body:`<div class="link-list"><a class="article-link" href="${CONFIG.links.controlBionics}" target="_blank" rel="noopener">Control Bionics website ↗</a><a class="article-link" href="${CONFIG.links.instagram}" target="_blank" rel="noopener">Control Bionics Australia Instagram ↗</a><a class="article-link" href="${CONFIG.links.booking}" target="_blank" rel="noopener">Book Product Specialist / Customer Support ↗</a><a class="article-link" href="${CONFIG.links.irisbond}" target="_blank" rel="noopener">IRISBOND Hiru ↗</a><a class="article-link" href="${CONFIG.links.intelligaze}" target="_blank" rel="noopener">Alea IntelliGaze ↗</a><a class="article-link" href="${CONFIG.links.grid3}" target="_blank" rel="noopener">Grid 3 for Windows ↗</a><a class="article-link" href="${CONFIG.links.grid3HowTo}" target="_blank" rel="noopener">How to use Grid 3 ↗</a><a class="article-link" href="${CONFIG.links.gridIPad}" target="_blank" rel="noopener">Grid for iPad ↗</a><a class="article-link" href="${CONFIG.links.smartboxInfo}" target="_blank" rel="noopener">Smartbox product information ↗</a><a class="article-link" href="${CONFIG.links.rehadapt}" target="_blank" rel="noopener">Rehadapt mounts ↗</a></div>` },
...
function performSearch(){
  ...
  if(q.includes("book")||q.includes("appointment")||q.includes("product specialist")) scored=[{type:"article",id:"booking",title:"Book with Control Bionics",desc:"Book a Product Specialist or Customer Support session",score:100},...scored.filter(x=>x.id!=="booking")];
  if(q.includes("hiru")||q.includes("irisbond")||q.includes("intelligaze")||q.includes("alea")) scored=[{type:"article",id:"eyegaze-resources",title:"Eye-gaze camera resources",desc:"Official IRISBOND Hiru and Alea IntelliGaze links",score:100},...scored.filter(x=>x.id!=="eyegaze-resources")];
  if(q.includes("mount")||q.includes("floorstand")||q.includes("floor stand")||q.includes("wheelchair")||q.includes("table stand")) scored=[{type:"article",id:"mount-resources",title:"Mounting resources",desc:"Rehadapt table, floor and wheelchair mounting information",score:100},...scored.filter(x=>x.id!=="mount-resources")];
  if(q.includes("smartbox")||q.includes("grid for ipad")||q.includes("grid ipad")) scored=[{type:"article",id:"grid-resources",title:"Official Smartbox Grid resources",desc:"Grid 3 Windows, Grid for iPad and Smartbox resources",score:100},...scored.filter(x=>x.id!=="grid-resources")];
